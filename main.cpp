...
int chooses(){
	...
	cout<<"@Copyright "<<year<<" kikikkii 版权所有"<<endl<<"Edgeless Compatible Plugin Loader v0.1 Alpha"<<endl<<"由于内存限制，本程序只能加载512个插件（反正普通人也不用那么多）"<<endl<<"是否加载Plugin目录下的所有插件？（1=确认 2=取消）";
	cin>>choose;
	return choose;
}
